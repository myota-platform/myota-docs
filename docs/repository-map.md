...
| `myota-activity-service` | activations, QSOs, programme-owned award definitions, condition evaluation, requests and issuance records | `services/activity.py`, `services/awards.py`, core migrations |
